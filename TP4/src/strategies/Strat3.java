...
public class Strat3 implements Strategie {
    ...
    private int probaLimite = 80;
    private int scoreDouble = 68;
    private int scoreDistMax = 2;
    private int scoreDistAdv = 1;
    private int scoreBonzeExiste = 38;
    private int scoreFinishLine = 43;
    private int scoreProba = 6;
    private int score = 0;
    private int scoreAdv = 0;
    private int tries = 0;
    private double[] probas = {13.20463,23.32046,35.59846,44.78764,56.13900,64.40154,56.13900,44.78764,35.59846,23.32046,13.20463};
